...
def dashboard_can():
    ...
    can_job = "select can_apply_pos.title, can_apply_pos.applytime, can_apply_pos.cid, company.cname from can_apply_pos inner join company on can_apply_pos.cid = company.cid where can_apply_pos.uid = :uid;"
